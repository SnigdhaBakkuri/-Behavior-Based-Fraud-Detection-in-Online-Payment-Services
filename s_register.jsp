...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">Service Provider Registration  </h2>
          <p align="center" class="style1"><img src="images/Register.jpg" width="343" height="103" /></p>
          <form name="s" action="s_RegIns.jsp" method="post" enctype="multipart/form-data" onSubmit="return valid()"  ons target="_top">
            ...
            <span class="style11 style7 style9">
            ...
            <p class="style4"><input type="password" id="password" name="pass" class="text" /></p>
                  ...
                  <span class="style11 style7 style12"><span class="style11">
                  ...
                  <span class="style11"><span class="style14">
                  ...
                  <span class="style11 style7 style12 style16"><span class="style11">
                  ...
                  <span class="style7 style12 style16 style11">
