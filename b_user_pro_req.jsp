	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
                      <td height="53"><div align="center" class="style9 style6"><%=j%></div></td>
		...
		%>
                      <td><div class="style9 style6">
                          <div align="center"><a href="b_user_pro_req1.jsp?usid=<%=i%>&user=<%=s2%>&pname=<%=s3%>" class="style12">Verify</a></div>
                      </div></td>
                      <%
		...
		%>
                      <td width="27"><div class="style9 style6">
                          <div align="center" class="style11">On Hold</div>
                      </div></td>
                      <%
		
			}
			else if(s4.equalsIgnoreCase("Purchased"))
			{
