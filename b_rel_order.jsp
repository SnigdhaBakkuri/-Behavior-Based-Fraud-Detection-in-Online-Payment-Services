...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1"> View All Released(Approved) Orders on<br />Purchased Products </h2>
		  <p>&nbsp;</p>
...
<%	  
 ...
 try 
	{		
		   String str="Approved",str2="Purchased";
		   String query="select * from Bank_req_res where upd_per='"+str+"' or upd_per='"+str2+"' "; 
