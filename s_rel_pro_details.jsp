...
<head>
<title>Released Purchased Products</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1"> View User's Released Purchased Products Details</h2>
...
<%	  
 ...
 try 
	{		
		   ...
		   String query="select * from Bank_req_res where upd_per='Approved' or upd_per='Purchased' "; 
		...
		%>
                      <td width="127"><div class="style9 style6 style17 style18">
