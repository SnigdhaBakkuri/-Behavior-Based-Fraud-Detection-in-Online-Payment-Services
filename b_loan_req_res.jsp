...
<head>
<title>Loan Requests and Response </title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">View Loan Requests and Response</h2>
		  <p>&nbsp;</p>
		  
		  
		  
		  
<p> <iframe src="b_loan_req_res1.jsp" style="border:3px;" width="620" height="300"></iframe> </p>		  
             ...
             <p>&nbsp;</p>
             <p align="right"><a href="b_main.jsp" class="style12">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
