...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">View Products Request From Users and Verify</h2>
		  <p>&nbsp;</p>
	...
	while ( rs.next() )
	   {
		...
		%>
                    ...
                    <tr>
                      <td height="53"><div align="center" class="style9 style6 style6"><%=j%></div></td>
                      <td><div align="center" class="style9 style6 style6"><%=s2%></div></td>
                      <td><div align="center" class="style9 style6 style6"><%=s3%></div></td>
					  <td><div align="center" class="style9 style6 style6"><%=s5%></div></td>
					  <td><div align="center" class="style9 style6 style6"><%=s6%></div></td>
                      <%
			if(s4.equalsIgnoreCase("Purchased"))
			{
			
		%>
                      <td width="27"><div class="style6 style9 style10 style12 style6">
                          <div align="center" class="style6">Approved and <%=s4%></div>
                      </div></td>
                      <%
		...
		%>
                      <td width="27"><div class="style6 style9 style10 style12 style6">
                          <div align="center" class="style6">On Hold</div>
                      </div></td>
                      <%
		...
		%>
                      <td width="27"><div class="style6 style9 style10 style12 style6">
                          <div align="center" class="style6"><%=s4%></div>
                      </div></td>
                    </tr>
                    <%
			  }
...
%>
			 ...
			 <p>&nbsp;</p>
             <p>&nbsp;</p>
             <p align="right"><a href="b_main.jsp" class="style9">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
        <div class="gadget">
