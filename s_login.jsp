...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">Service Provider  Login</h2>
		  <p><img src="images/Login.jpg" width="244" height="79" /></p>
...
<form name="s" action="s_authentication.jsp" method="post" onSubmit="return valid()"  ons target="_top">  
	...
	<p align="center"><a href="s_register.jsp" class="style7">New User? Register Here</a></p>
