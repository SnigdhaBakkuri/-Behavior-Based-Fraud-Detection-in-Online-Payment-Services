...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">Welcome to User Main : <span class="style8"><%=application.getAttribute("user")%></span></h2>
		  <p align="right"><img src="images/User.png" width="537" height="196" /></p>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="u_account.jsp">My Online Account</a></li>
			<li><a href="u_search_pro.jsp">Serach Products based on Keyword </a></li>
			<li><a href="u_purchased_pro_sta.jsp">View Purchased Products Status </a></li>
			<li><a href="u_purchased_pro.jsp">View All Purchased Products </a></li>
			<li><a href="u_req_loan.jsp">Request Loan</a></li>
			<li><a href="u_loan_resp.jsp">View Bank Loan Approval Response </a></li>
