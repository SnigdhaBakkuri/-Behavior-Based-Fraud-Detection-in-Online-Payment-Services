...
<form name="s" action="u_add_money_ins.jsp?type=<%=type%>" method="post" onSubmit="return valid()"  ons target="_top"> 
  ...
  <%
			...
			if(type.equalsIgnoreCase("vvgoodbad"))
			{
			  %><p align="right"><a href="u_account.jsp" class="style4">Back</a></p><%
			}
            else if(type.equalsIgnoreCase("vgoodbad"))
			{
			%><p align="right"><a href="u_purchased_pro_sta.jsp" class="style4">Back</a></p><%
			}
