...
<%
					...
					try {
						...
						//image = image.replace(".", "_b.");
			 			String query1="select * from sp where name='"+uname+"'"; 
					...
					if ( rs1.next() )
					   ...
					   {
					String sta="waiting";
					PreparedStatement ps=connection.prepareStatement("insert into sp(name,pass,email,mobile,addr,dob,gender,pin,location,image,status) values(?,?,?,?,?,?,?,?,?,?,?)");
						...
						if(x>0){
								...
								out.println("Service Provider Registered Sucessfully ");							
