...
<head>
<title>View Products Rank</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 align="center" class="style1">View All Products Rank<br />(No. Of Time Products Purchased)</h2>
		  <p>&nbsp;</p>
		  
		  
		  
		  <p align="left"><iframe src="graph1.jsp" style="border:3px;" width="800" height="400"> </iframe></p>
