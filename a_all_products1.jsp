...
<table width="965" border="1" align="center" cellspacing="0" cellpadding="5">
  <tr>
              ...
              <td width="136" bgcolor="#FF00FF"><div align="center" class="style3 style4 style5 style9 style2">Description(Encrypted)</div></td>
			  ...
			  <td width="127" bgcolor="#FF00FF"><div align="center" class="style3 style4 style5 style9 style2">Product Uploader(SP)</div></td>
	...
	<tr>
              ...
              <td><div align="center" class="style9 style10">
                <textarea name="text" cols="10" rows="7" readonly><%= s3 %></textarea>
              </div></td>
              <td><div align="center" class="style9 style10">
                <textarea name="text" cols="10" rows="7" readonly><%= s4 %></textarea>
              </div></td>
              <td height="29"><div align="center" class="style9 style10"><%=s5%></div></td>
			  <td height="29"><div align="center" class="style9 style10"><%=s8%></div></td>
